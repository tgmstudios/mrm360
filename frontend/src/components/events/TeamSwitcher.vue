<template>
  ...
  <div v-else-if="allowTeamSwitching && !currentTeam" class="bg-gray-800 shadow rounded-lg border border-gray-700 p-6">
    <div class="text-center">
      ...
      <h3 class="text-lg font-medium text-gray-100 mb-2">Not Assigned to a Team</h3>
      <p class="text-sm text-gray-400 mb-4">
        You're checked in but haven't been assigned to a team yet. Contact an admin for assistance.
      </p>
    </div>
  </div>
</template>
