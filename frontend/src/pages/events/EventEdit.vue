          ...
          <div v-if="provisionTask" class="mb-4 p-4 border border-blue-600 rounded-md bg-blue-900">
            ...
            <div>
              ...
              <div>
                ...
                <div v-if="form.linkedTeamId" class="mt-2 p-2 bg-amber-900/30 border border-amber-600/50 rounded-lg">
                  <p class="text-xs text-amber-400 flex items-center">
                    <svg class="w-4 h-4 mr-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                    </svg>
                    <span><strong>Team Restriction:</strong> This event will only be visible to members of the selected team.</span>
                  </p>
                </div>
              </div>
            </div>
